...
export const LEVELS: readonly LevelDef[] = [
  { id: 'e0-lines', name: 'First Lines', n: 1, chapter: 'shallows', goal: 'lines', target: 3, fairness: 'guided', nextName: 'First Score' },
  { id: 'e0-score', name: 'First Score', n: 7, chapter: 'shallows', goal: 'score', target: 500, moveLimit: 20, fairness: 'guided' },
  { id: 'e0-survive', name: 'First Tide', n: 21, chapter: 'deep', goal: 'survive', target: 4, fairness: 'fair', tideRate: 1.0 },
] as const;
